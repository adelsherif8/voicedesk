...
def _seed():
    ...
    demo = [
        ...
        ("restaurant", "Marcus Bell", "+1 555 771 0098", "", "Takeout · lasagna + cannoli",
         "Order to kitchen · $47.00", "Pickup 7:05 PM", "Takeout: 1× Lasagna, 1× Arugula salad, 2× Cannoli (upsold). Read back total $47.00; paid by card; ticket printed to kitchen; ready-text sent.",
         {"kind": "order", "items": [["Lasagna", 1, 24.0], ["Arugula salad", 1, 11.0], ["Cannoli", 2, 12.0]], "total": 47.0, "pickup": "7:05 PM", "upsell": "Cannoli", "allergy": "", "paid": True, "ready": True, "minutes": 14}, now - 3300),

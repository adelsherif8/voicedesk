...
def _seed():
    ...
    demo = [
        ...
        ("recovery", "Maria Lopez", "+1 555 402 8810", "", "Kitchen sink backed up",
         "Booked · $89 dispatch", "Today 2–4 PM", "Missed call 10:41 (crew under a sink). Text-back sent in 8s, AI called back in 52s. Sink fully blocked. Booked same-day 2–4 PM, $89 dispatch credited to repair.",
         {"flow": "missed", "stage": "booked", "callback_secs": 52, "text_back_secs": 8, "value": 320, "source": "Google"}, now - 1500),
        ("recovery", "Tom Brennan", "+1 555 771 3302", "tom.b@mail.com", "Water heater estimate $2,400",
         "Estimate closed · $2,400", "Install Thu 9 AM", "Estimate #2231 sent 3 days ago, no reply. AI follow-up: objection was price → offered 0% / 12 mo ($200/mo). Booked install Thursday 9 AM.",
         {"flow": "estimate", "stage": "booked", "estimate": 2400, "value": 2400, "days_open": 3, "objection": "price", "financing": "0% · 12 mo"}, now - 3600),

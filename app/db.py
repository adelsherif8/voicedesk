...
def _seed():
    ...
    demo = [
        ...
        ("restaurant", "Marcus Bell", "+1 555 771 0098", "", "Takeout · 2 pizzas + salad",
         ...
         {"kind": "order", "items": [["Margherita pizza", 2, 32.0], ["Caesar salad", 1, 9.5], ["Tiramisu", 1, 7.0]], "total": 48.5, "pickup": "7:15 PM", "upsell": "Tiramisu", "allergy": "", "paid": True}, now - 3300),
        ("restaurant", "Priya Nair", "+1 555 301 7745", "", "Takeout · gluten-free pasta",
         ...
         {"kind": "order", "items": [["Rigatoni alla vodka (GF)", 1, 22.0], ["Garlic bread", 1, 9.0]], "total": 31.0, "pickup": "6:50 PM", "allergy": "Gluten — flagged to kitchen", "paid": True}, now - 5400),

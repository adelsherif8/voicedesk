...
async def main():
    ...
    async with async_playwright() as p:
        ...
        t=12.1; beats={1:[("chip(1)",1.5)],2:[("chip(2)",1.8),("chip(3)",4.0)],4:[("chip(4)",0.3),("chip(5)",2.2)]}
        ...
        audio(L["narr"]["save"]["file"],T+0.4); await api("callout('New patient on the schedule · insurance verified · forms texted',70,700)")
